...
- **Notes:**
  - This is NOT a git template repository, its a workflow template repository.
  - This is a template repository used to test multiple security GitHub Actions. Vulnerabilities are intentionally introduced for testing purposes only. The resulting vulnerable image will not be published to any ECR or deployed to any environment.
