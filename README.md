...
- **Notes:**
  - This is a template repository where it is used to test multiple security GitHub Actions. The vulnerability here is deliberately done for testing vulnerabilities only. This vulnerable image wont be published to any ECR and wont be deployed anywhere. 
